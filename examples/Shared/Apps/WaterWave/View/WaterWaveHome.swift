                        ...
                        .overlay(alignment: .bottom){
                            ...
                            Button {
                                ...
                                Image(systemName: "plus")
                                    ...
                                    .foregroundColor(Color("WaterWave_Blue"))
                                    .shadow(radius: 2)
                                    .padding(25)
                                    .background(.white,in: Circle())
                            }
...
//                .padding(.top,50)
        ...
        .background(Color("WaterWave_BG"))
    }
}

struct WaterWaveHome_Previews: PreviewProvider {
