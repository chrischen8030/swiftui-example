...
struct BoomerangCardsHome: View {
    // MARK: Sample Cards
    ...
    var body: some View {
        VStack(spacing: 20){
            Button {
                ...
                Image(systemName: "backward").accentColor(Color.white)
            }
...
struct BoomerangCardsHome_Previews: PreviewProvider {
