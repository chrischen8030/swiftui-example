...
struct TaskManagementCoreDataHome: View {
    @StateObject var taskModel: TaskManagementCoreDataTaskViewModel = TaskManagementCoreDataTaskViewModel()
    ...
    func TasksView()->some View{
        ...
        LazyVStack(spacing: 20){
            ...
            TaskManagementCoreDataDynamicFilteredView(dateToFilter: taskModel.currentDay) { (object: TaskManagementCoreDataTask) in
    ...
    // MARK: Task Card View
    @ViewBuilder
    func TaskCardView(task: TaskManagementCoreDataTask)->some View{
...
struct TaskManagementCoreDataHome_Previews: PreviewProvider {
    static var previews: some View {
        TaskManagementCoreDataHome()
    }
}
