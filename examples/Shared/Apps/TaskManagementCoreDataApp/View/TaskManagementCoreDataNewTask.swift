...
struct TaskManagementCoreDataNewTask: View {
    ...
    @EnvironmentObject var taskModel: TaskManagementCoreDataTaskViewModel
    var body: some View {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    Button("Save"){
                        ...
                        if let task = taskModel.editTask{
                            ...
                            let task = TaskManagementCoreDataTask(context: context)
                            task.taskTitle = taskTitle
                            task.taskDescription = taskDescription
