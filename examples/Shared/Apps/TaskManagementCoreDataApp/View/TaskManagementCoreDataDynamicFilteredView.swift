...
struct TaskManagementCoreDataDynamicFilteredView<Content: View,T>: View where T: NSManagedObject {
    ...
    init(dateToFilter: Date,@ViewBuilder content: @escaping (T)->Content){
        ...
        // Adding Sort
        _request = FetchRequest(entity: T.entity(), sortDescriptors: [.init(keyPath: \TaskManagementCoreDataTask.taskDate, ascending: false)], predicate: predicate)
