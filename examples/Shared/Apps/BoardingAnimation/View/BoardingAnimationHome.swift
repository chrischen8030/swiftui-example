...
struct BoardingAnimationHome: View {
        ...
        ZStack{
            ...
            GeometryReader{proxy in
                ...
                ForEach(1...3,id: \.self){index in
                    ...
                    Image("BoardingAnimationPic\(index)")
                        .resizable()
            ...
            VStack(spacing: 20){
                ...
                BoardingAnimationSignInButton(image: "applelogo", text: "Continue with Apple", isSystem: true) {
                    dismiss()
                    
                }
                .padding(.top)
                
                BoardingAnimationSignInButton(image: "BoardingAnimationgoogle", text: "Continue with Google", isSystem: false) {
                    
                    
                }
                
                BoardingAnimationSignInButton(image: "BoardingAnimationfacebook", text: "Continue with Facebook", isSystem: false) {
...
struct BoardingAnimationHome_Previews: PreviewProvider {
    static var previews: some View {
        BoardingAnimationHome()
    }
}

struct BoardingAnimationSignInButton: View{
