...
struct HeroCarouselHome: View {
    @EnvironmentObject var model: HeroCarouselViewModel
    ...
    var body: some View {
        ...
        ZStack {
                ...
                ZStack{
                    ...
                    ForEach(model.cards.indices.reversed(),id: \.self){index in
                        ...
                        HStack {
                            ...
                            HeroCarouselCardView(card: model.cards[index], animation: animation)
            ...
            if model.showCard{
                ...
                HeroCarouselDetailView(animation: animation)
            }
        }
    }
...
struct HeroCarouselHome_Previews: PreviewProvider {
    @StateObject static var homeModel = HeroCarouselViewModel()
    static var previews: some View {
        HeroCarouselHome().environmentObject(homeModel)
    }
}
