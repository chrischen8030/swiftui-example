...
class HeroCarouselViewModel: ObservableObject {

  @Published var cards = [

        HeroCarouselCard(cardColor: Color("herocardblue"), title: "Neurobics for your mind."),
        HeroCarouselCard(cardColor: Color("herocardpurple"), title: "Brush up on hygine."),
        HeroCarouselCard(cardColor: Color("herocardgreen"), title: "Don't skip breakfast."),
        HeroCarouselCard(cardColor: Color.yellow, title: "Brush up on hygine."),
        HeroCarouselCard(cardColor: Color.orange, title: "Neurobics for your mind."),
    ]
    ...
    @Published var selectedCard = HeroCarouselCard(cardColor: .clear, title: "")
