...
struct CoverFlowHome: View {
    
    @StateObject var pageData = CoverFlowPageViewModel()
    // Slide Animation...
                ...
                LazyVGrid(columns: columns,spacing: 20, content: {
                    ...
                    ForEach(pageData.urls){page in
                        ...
                        // Drag And Drop ....
                            ...
                            .onDrop(of: [.url], delegate: CoverFlowDropViewDelegate(page: page,pageData: pageData))
                    }
                })
                .padding()
            }
...
struct CoverFlowHome_Previews: PreviewProvider {
