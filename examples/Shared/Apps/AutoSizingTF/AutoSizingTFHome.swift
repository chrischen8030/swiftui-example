...
//  AutoSizing TF
//
//  Created by 陳　愛 on 2022/11/27.
//

import SwiftUI

struct AutoSizingTFHome: View {
        ...
        NavigationView{
            ...
            VStack{
                ...
                AutoSizingTF(hint: "Enter Message", text: $text,containerHeight: $containerHeight, onEnd: {
                    ...
                    .frame(height: containerHeight <= 5000 ? containerHeight : 500)
...
struct AutoSizingTFHome_Previews: PreviewProvider {
