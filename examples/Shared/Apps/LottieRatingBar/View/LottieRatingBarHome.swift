...
struct LottieRatingBarHome: View {
...
struct LottieRatingBarHome_Previews: PreviewProvider {
    ...
    var body: some View{
        ...
        VStack(spacing: 15){
            ...
            GeometryReader{proxy in
                ...
                LtAnimationView(jsonFile: "Rating", progress: $currentSliderProgress)
        ...
        .background(
            ...
            LinearGradient(colors: [
                ...
                Color("BG1_LottieRatingBar"),
                Color("BG2_LottieRatingBar"),
                Color("BG2_LottieRatingBar"),
                Color("BG2_LottieRatingBar"),
                Color("BG3_LottieRatingBar"),
                Color("BG3_LottieRatingBar"),
