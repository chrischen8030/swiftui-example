...
struct TaskAnimationCustomDatePicker: View {
    ...
    func extractDate()->[TaskAnimationDateValue]{
        ...
        var days = currentMonth.getAllDates().compactMap { date -> TaskAnimationDateValue in
            
            // getting day...
            let day = calendar.component(.day, from: date)
            
            return TaskAnimationDateValue(day: day, date: date)
        }
        ...
        for _ in 0..<firstWeekday - 1{
            days.insert(TaskAnimationDateValue(day: -1, date: Date()), at: 0)
        }
...
struct PickerCardView: View{
    var value: TaskAnimationDateValue
    var index: Int
    @Binding var currentDate: Date
