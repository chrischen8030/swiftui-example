...
struct WalletAnimationHome: View {
    // MARK: Animation Properties
    @State var expandCards: Bool = false
    
    // MARK: Detail View Properties
    @State var currentCard: WalletAnimationCard?
    ...
    var body: some View {
        VStack(spacing: 0){
            ...
            ScrollView(.vertical, showsIndicators: false) {
                ...
                VStack(spacing: 0){
                    ...
                    // MARK: Cards
                    ForEach(walletAnimationcards){card in
        ...
        .overlay {
            if let currentCard = currentCard,showDetailCard {
                WalletAnimationDetailView(currentCard: currentCard, showDetailCard: $showDetailCard,animation: animation)
            }
        }
    }
    ...
    // MARK: Card View
    @ViewBuilder
    func CardView(card: WalletAnimationCard)->some View{
    ...
    // Retreiving Index
    func getIndex(Card: WalletAnimationCard)->Int{
        return walletAnimationcards.firstIndex { currentCard in
...
struct WalletAnimationHome_Previews: PreviewProvider {
...
// MARK: Detail View
struct WalletAnimationDetailView: View{
    var currentCard: WalletAnimationCard
    ...
    var body: some View{
            ...
            GeometryReader{proxy in
                ...
                ScrollView(.vertical, showsIndicators: false) {
                    ...
                    VStack(spacing: 20){
                        ...
                        // Expenses
                        ForEach(walletAnimationexpenses){expense in
                            // Card View
        ...
        .background(Color("WalletAnimationBG").ignoresSafeArea())
        .onAppear {
...
struct ExpenseCardView: View{
    var expense: WalletAnimationExpense
    ...
    func getIndex()->Int{
        return walletAnimationexpenses.firstIndex { currentExpense in
