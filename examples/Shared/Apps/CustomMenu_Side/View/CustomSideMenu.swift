        ...
        Button {
            ...
            HStack(spacing: 12){
                ...
                Image(systemName: icon)
                    ...
                    .foregroundColor(currentTab == title ? Color("custommenuPurple") : (title == "Logout" ? Color("custommenuOrange") : .white))
                    .background(
                ...
                Text(title)
                    .font(.callout)
                    .fontWeight(.semibold)
                    .foregroundColor(title == "Logout" ? Color("custommenuOrange") : .white)
            }
            .padding(.trailing,18)
            .background(
