...
struct AnimatedIndicatorHome: View {
        ...
        NavigationView{
            VStack{
                HStack{
                    ...
                    Spacer()
                    Text("Dribbble Ball Animation")
                    Spacer()

                }
                AnimatedIndicatorHomeContext()
            }
...
struct AnimatedIndicatorHome_Previews: PreviewProvider {
    static var previews: some View {
        AnimatedIndicatorHome()
    }
}

struct AnimatedIndicatorHomeContext: View {
