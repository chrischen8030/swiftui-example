...
struct MatchedCarouselCarouselBodyView: View {
    var index: Int
    // Offset
    ...
    var body: some View {
        ...
        .modifier(MatchedCarouselScrollViewOffsetModifier(anchorPoint: .leading, offset: $offset))
    }
...
struct MatchedCarouselCarouselBodyView_Previews: PreviewProvider {
