...
struct VPNUIHome: View {
    @State var isConnected = false
    
    // Current Server...
    @State var currentServer: VpnuiServer = vpnuiServers.first!
    ...
    func BottomSheet()->some View{
        ...
        .background(
            ...
            Color("vpnuiBottomSheet")
                .clipShape(VpnuiCustomCorners(radius: 35, corners: [.topLeft,.topRight]))
        )
        ...
        Button {
            ...
            ZStack{
                ...
                Image(systemName: "power")
                    ...
                    .foregroundColor(isConnected ? .white : Color("vpnuiPower"))
            ...
            .background(
                ...
                ZStack{
                    ...
                    // Shadows...
                        .shadow(color: Color("vpnuiRing1"), radius: 5, x: 1, y: -4)
                    ...
                    // Shadows...
                        .shadow(color: Color("vpnuiRing2"), radius: 5, x: 1, y: -4)
                    ...
                    // Toggling Shadow when button is Clicked...
                        .shadow(color: Color("vpnuiRing2").opacity(isConnected ? 0.04 : 0), radius: 5, x: 1, y: -4)
                }
            )
        }
