...
struct DCardAnimationHome: View {
    // MARK: Animation Properties
    @State var expandCards: Bool = false
    @State var currentCard: DCardAlbum?
    ...
    var body: some View {
        ...
        .background{
            Color("BG_3DCardAnimation").ignoresSafeArea()
        }
        .overlay {
            // Detail View
    ...
    // MARK: Detail View
    @ViewBuilder
    func DetailView(currentCard: DCardAlbum)-> some View{
        VStack(spacing: 0){
            Button {
                rotateCards = false
                withAnimation{
    ...
    // MARK: Album CardView
    @ViewBuilder
    func AlbumCardView(album: DCardAlbum)->some View{
        HStack(spacing: 12){
            Image(album.albumImage)
                .resizable()
                .aspectRatio(contentMode: .fill)
    ...
    // MARK: Array Index
    func getIndex(album: DCardAlbum)->Int{
...
struct DCardAnimationHome_Previews: PreviewProvider {
