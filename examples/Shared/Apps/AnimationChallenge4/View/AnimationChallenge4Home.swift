...
struct AnimationChallenge4Home: View {
    // MARK: Albums
    ...
    var body: some View {
        ...
        .background(Color("BG_AnimationChallenge4"), ignoresSafeAreaEdges: .all)
        .onAppear {
...
struct AnimationChallenge4Home_Previews: PreviewProvider {
