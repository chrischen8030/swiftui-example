...
// Custom View....
struct CryptoAppAppLineGraph: View {
    // Number of plots...
    var data: [Double]
    ...
    var body: some View {
        ...
        GeometryReader{proxy in
            ...
            ZStack{
                ...
                // Path....
                CryptoAppAppAnimatedGraphPath(progress: graphProgress, points: points)
                .fill(
                
                    // Gradient...
                    LinearGradient(colors: [
                    
                        profit ? Color("CoverProfit") : Color("CoverLoss"),
                        profit ? Color("CoverProfit") : Color("CoverLoss"),
            ...
            .overlay(
                ...
                VStack(spacing: 0){
                    ...
                    Text(currentPlot)
                        ...
                        .padding(.vertical,6)
                        .frame(width: 100)
                        .background(Color("CoverGradient1"),in: Capsule())
                        .offset(x: translation < 10 ? 30 : 0)
                        .offset(x: translation > (proxy.size.width - 60) ? -30 : 0)
                    
                    Rectangle()
                        .fill(Color("CoverGradient1"))
    ...
    func FillBG()->some View{
        let color = profit ? Color("CoverProfit") : Color("CoverLoss")
        LinearGradient(colors: [
...
// MARK: Animated Path
struct CryptoAppAppAnimatedGraphPath: Shape{
