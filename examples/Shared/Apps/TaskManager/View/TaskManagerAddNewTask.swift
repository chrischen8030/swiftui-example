...
struct TaskManagerAddNewTask: View {
    @EnvironmentObject var taskModel: TaskManagerTaskViewModel
...
struct TaskManagerAddNewTask_Previews: PreviewProvider {
    static var previews: some View {
        TaskManagerAddNewTask()
            .environmentObject(TaskManagerTaskViewModel())
    }
}
