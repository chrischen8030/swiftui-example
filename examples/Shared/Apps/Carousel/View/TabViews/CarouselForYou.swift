    ...
    var body: some View {
        ...
        VStack(spacing: 15){
            ...
            GeometryReader{proxy in
                ...
                CarouselVerticalCarouselList {
                    
                    VStack(spacing: 0){
                        
                        // Movies....
                        ForEach(carouselmovies){movie in
                            ...
                            CarouselMovieCardView(movie: movie,topOffset: 70 + 15 + topEdge)
...
struct CarouselMovieCardView: View{
    
    var movie: CarouselMovie
