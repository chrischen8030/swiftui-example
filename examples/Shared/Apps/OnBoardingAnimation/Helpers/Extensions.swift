            ...
            .overlay {
                if enabled{
                    ...
                    GeometryReader{proxy in
                        ...
                        OnBoardingAnimationSpotlightView(rect: rect,title: title) {
                            self
                        }
                    }
                }
...
// MARK: Spotlight View
struct OnBoardingAnimationSpotlightView<Content: View>: View{
    ...
    func overlaySwiftUIView()->some View{
        ZStack{
            ...
            Rectangle()
                .fill(Color("OnBoardingAnimationSpotlight").opacity(scheme == .dark ? 0.9 : 0.8))
