...
// Link in Description....
struct OnBoardingAnimationOffsetPageTabView<Content: View>: UIViewRepresentable {
    ...
    func makeCoordinator() -> Coordinator {
        return OnBoardingAnimationOffsetPageTabView.Coordinator(parent: self)
    }
    ...
    class Coordinator: NSObject,UIScrollViewDelegate{
        ...
        var parent: OnBoardingAnimationOffsetPageTabView
        
        init(parent: OnBoardingAnimationOffsetPageTabView) {
            self.parent = parent
        }
