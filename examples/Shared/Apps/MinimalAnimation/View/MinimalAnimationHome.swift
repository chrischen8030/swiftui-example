...
struct MinimalAnimationHome: View {
    // MARK: UI Properties
    ...
    var body: some View {
        VStack(spacing: 20){
            ...
            MinimalAnimationFitnessRingCardView()
                .opacity(showViews[3] ? 1 : 0)
                .offset(y: showViews[3] ? 0 : 250)
            
            // MARK: Bar Graph View
            MinimalAnimationFitnessStepsGraphView()
...
struct MinimalAnimationHome_Previews: PreviewProvider {
