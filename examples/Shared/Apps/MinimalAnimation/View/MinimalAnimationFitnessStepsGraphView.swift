...
struct MinimalAnimationFitnessStepsGraphView: View {
    var body: some View {
        VStack(spacing: 15){
            Text("Steps by hours")
                .fontWeight(.semibold)
            ...
            // Link in Description
            MinimalAnimationBarGraph(steps: minimalAnimationSteps)
        }
...
struct MinimalAnimationBarGraph: View {
    var steps: [MinimalAnimationStep]
    var body: some View {
        // Graph View
        GraphView()
            .padding(.top,20)
                    ...
                    ForEach(steps.indices,id: \.self){index in
                        ...
                        VStack(spacing: 0){
                            ...
                            VStack(spacing: 5){
                                ...
                                MinimalAnimationAnimatedBarGraph(step: steps[index], index: index)
                            }
...
struct MinimalAnimationAnimatedBarGraph: View{
    var step: MinimalAnimationStep
    var index: Int
