...
struct CircleWalletHome: View {
    
    @State var currentTab = "Incomings"
    // For Segment Tab Slide....
    @Namespace var animation
    
    @State var weeks : [CircleWalletWeek] = []
    
    // Current Week Day...
    @State var currentDay: CircleWalletWeek = CircleWalletWeek(day: "", date: "", amountSpent: 0)
    ...
    var body: some View {
        ...
        VStack{
            ...
            ZStack{
                ...
                if UIScreen.main.bounds.height < 750{
                    ScrollView(.vertical, showsIndicators: false, content: {
                        ...
                        CircleWalletBottomSheet(weeks: $weeks, currentDay: $currentDay)
            ...
            .background(
                Color.white
                    .clipShape(CircleWalletCustomShape(corners: [.topLeft,.topRight], radius: 35))
                    .ignoresSafeArea(.all, edges: .bottom)
            )
        }
        .frame(maxWidth: .infinity, maxHeight: .infinity)
        .background(Color("circlewalletbg").ignoresSafeArea())
        .onAppear(perform: {
            getWeekDays()
        })
    }
    ...
    func getWeekDays(){
        ...
        for index in 0..<7{
            ...
            // Random Amount...
            weeks.append(CircleWalletWeek(day: day, date: dateString,amountSpent: index == 0 ? 60 : CGFloat(index) * 70))
        }
...
struct CircleWalletBottomSheet: View {
    
    @Binding var weeks: [CircleWalletWeek]
    @Binding var currentDay: CircleWalletWeek
        ...
        VStack{
            ...
            Button(action: {}, label: {
                Image("circlewalletarrow")
                    ...
                    .background(Color("circlewalletbg"))
                    .clipShape(Capsule())
                    .foregroundColor(.white)
            })
            .padding(.top)
