...
struct CustomHUDsContentView: View {
    var body: some View {
...
struct CustomHUDsContentView_Previews: PreviewProvider {
    static var previews: some View {
        CustomHUDsContentView()
    }
}

struct CustomHUDsHome: View{
...
extension View{
    ...
    func showHUD(image: String,color: Color = .primary,title: String,completion: @escaping (Bool,String)->()){
        ...
        let hudViewController = UIHostingController(rootView: CustomHUDsHUDView(image: image, color: color, title: title))
        // Content Size...
