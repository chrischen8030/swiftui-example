...
struct AnimatedHeaderHome: View {
    @StateObject var homeData = AnimatedHeaderHomeViewModel()
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            LazyVStack(alignment: .leading, spacing: 15, pinnedViews: [.sectionHeaders], content: {
                ...
                Section(header: AnimatedHeaderView()) {

                    // Tabs With Content.....
                    
                    ForEach(animatedHeaderTabsItems){tab in
                        ...
                        VStack(alignment: .leading, spacing: 15, content: {
                            ...
                            ForEach(tab.foods){food in
                                ...
                                AnimatedHeaderCardView(food: food)
                            }
...
struct AnimatedHeaderHome_Previews: PreviewProvider {
