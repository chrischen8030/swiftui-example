...
struct WelcomeScreenHome: View {
    ...
    var body: some View{
        ...
        VStack{
            ...
            WelcomeScreenCustomTabIndicator(count: 3, current: $currentIndex)
        ...
        .background(Color("WelcomeScreenbg").ignoresSafeArea())
    }
}


struct WelcomeScreenCustomTabIndicator: View {
