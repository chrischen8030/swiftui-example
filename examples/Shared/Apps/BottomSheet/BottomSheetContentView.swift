        ...
        ZStack(alignment: Alignment(horizontal: .center, vertical: .bottom), content: {
            ...
            GeometryReader{reader in
                ...
                VStack{
                    ...
                    BottomSheetBottomSheet(offset: $offset, value: (-reader.frame(in: .global).height + 150))
...
struct BottomSheetBottomSheet : View {
    ...
    var body: some View{
        ...
        VStack{
            ...
            .background(BottomSheetBlurView(style: .systemMaterial))
            .cornerRadius(15)
            .padding()
            ...
            ScrollView(.vertical, showsIndicators: false, content: {
                ...
                LazyVStack(alignment: .leading, spacing: 15, content: {
                    ForEach(1...15, id: \.self) { count in
                        ...
                        Text("Searched Place").onTapGesture {
                            dismiss()
                        }
