...
struct CustomTabBar: View {
    ...
    @Binding var currentTab: AnimationsHomeTab
    ...
    var body: some View {
        ...
        HStack(spacing: 0){
            ...
            // TabButtons...
            // Iterating Tab Enum....
            ForEach(AnimationsHomeTab.allCases,id: \.rawValue){tab in
    ...
    func getOffset()->CGFloat{
        ...
        let index = AnimationsHomeTab.allCases.firstIndex { checkTab in
...
struct TabButton: View{
    var tab: AnimationsHomeTab
    var animation: Namespace.ID
    @Binding var currentTab: AnimationsHomeTab
    // Sending back the result...
    var onTap: (AnimationsHomeTab)->()
