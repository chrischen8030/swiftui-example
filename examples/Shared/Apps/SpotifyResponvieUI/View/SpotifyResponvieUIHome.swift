...
struct SpotifyResponvieUIHome: View {
    @State var currentType: String = "Popular"
    // MARK: For Smooth Sliding Effect
    @Namespace var animation
    @State var _albums: [SpotifyResponvieUIAlbum] = spotifyResponvieUIalbums
                ...
                LazyVStack(pinnedViews: [.sectionHeaders]) {
                    Section {
                        ...
                        PinnedHeaderView()
                            ...
                            .modifier(SpotifyResponvieUIOffsetModifier(offset: $headerOffsets.0, returnFromStart: false))
                            .modifier(SpotifyResponvieUIOffsetModifier(offset: $headerOffsets.1))
                    }
                }
            }
        }
                ...
                HStack(spacing: 12){
                    ...
                    Button {
                        ...
                        Image(systemName: album.isLiked ? "suit.heart.fill" : "suit.heart")
                            .font(.title3)
                            .foregroundColor(album.isLiked ? Color("SpotifyResponvieUIGreen") : .white)
                    }
    ...
    func getIndex(album: SpotifyResponvieUIAlbum)->Int{
    ...
    func HeaderView()->some View{
        GeometryReader{proxy in
            ...
            Image("SpotifyResponvieUIAriana")
                .resizable()
                .aspectRatio(contentMode: .fill)
...
struct SpotifyResponvieUIHome_Previews: PreviewProvider {
